...
struct AuthView: View {
    ...
    @State private var nextToSignProcessView = false
    ...
    var body: some View {
        ...
        NavigationStack {
            ZStack {
                VStack(spacing: 0) {
                    ...
                    PrimaryButton(title: viewModel.buttonTitle) {
                        ...
                        //TO DO: VALIDATE ALL FIELD
                        nextToSignProcessView = true
                    }
            ...
            .navigationDestination(isPresented: $nextToSignProcessView) {
